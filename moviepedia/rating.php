...
<form action="ratingphp.php" name="ab" method="post">
    
    <div class="container">
    
    <table>
		<tr>
			<td width=100% >Choose Movie to Rate</td>
        </tr>
        <tr><td>&nbsp;
...
&nbsp;
              ...
              <tr>&nbsp;
                  <td width=50%>New Rating</td></tr>
        <tr>
            <td> &nbsp;<input type="text" name="mov_rating" placeholder="Rate b/w 1-10" size="30" maxlength="20" border-radius="4px"  required></td>
		</tr>   
