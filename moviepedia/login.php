...
<img src="images/jujujuj.PNG">
  ...
  <div class="form">
    ...
    <form class="login-form" action="auth.php" method="post">
      <input type="text" name="iname" placeholder="username"/>
      <input type="password" name="ipassword" placeholder="password"/>
...
if (isset($_POST["register"]))
{
	...
	$insert_sql="INSERT INTO `userdet`(`user_name`, `user_password`, `email`) VALUES ('$name','$password','$email')";
	if($dbconnect->query($insert_sql) === TRUE)
	{
		echo "$name". " " ."$message";
